let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝗤𝗨𝗘𝗘𝗡 *HENTAI* 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VajIDgjDZ4LVnxfB1Z2s\n\n ${Config.botname} *© VERAN TECH HUB*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*QUEEN-HENTAI CURRENTLY ACTIVE!*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Veran350/QUEEN-HENTAI*");
     }
 ...
 let tmpUrl = "https://files.catbox.moe/egryl3.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
